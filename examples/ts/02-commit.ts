...
export async function run(): Promise<void> {
  ...
  // output size.
  const lease = await transcode
    .draw("encoder-seconds", 360)
    .draw("output-megabytes", 800)
    .idempotent("transcode-job-4417")
